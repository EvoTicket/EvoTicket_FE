            ...
            case "SUCCESS":
                return (
                    <>
                        ...
                        <div className="w-full bg-feedback-info-bg border border-feedback-info-border rounded-lg p-3 text-sm text-feedback-info-text mb-8 text-left">
                            {tr('nft_issuing_note')}
                        </div>
            ...
            case "FAILED":
                return (
                    <>
                        ...
                        <div className="w-full bg-feedback-warning-bg border border-feedback-warning-border rounded-lg p-4 text-sm text-feedback-warning-text mt-6 text-left">
